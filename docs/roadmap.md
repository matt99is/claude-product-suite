...
- [x] Add a progressive-disclosure maintenance pass for `figma-writing`: split the growing pitfalls catalogue into category-specific references, keeping `SKILL.md` as the lean router and turning `pitfalls.md` into an index.
